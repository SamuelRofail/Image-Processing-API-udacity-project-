...
describe('Test image processing with sharp', function () {
    it('raises an error (invalid width value)', function () { return __awaiter(void 0, void 0, void 0, function () {
        var error;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fileHandler_1.default.createImage({
                        filename: 'boo',
                        width: '-100',
                        height: '500'
                    })];
    ...
    it('raises an error (filename does not exist)', function () { return __awaiter(void 0, void 0, void 0, function () {
        var error;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fileHandler_1.default.createImage({
    ...
    it('succeeds to write resized thumb file (existing file, valid size values)', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, fileHandler_1.default.createImage({ filename: 'fjord', width: '250', height: '250' })];
                case 1:
                    _b.sent();
